    ...
    */
    ...
    if (! isset($latestNews)) {
        ...
        if (empty($latestNews)) {
            $latestNews = [
                [
                    'title'    => 'الأمم المتحدة تدعو إلى وقف فوري لإطلاق النار في غزة',
                    'excerpt'  => 'دعا الأمين العام للأمم المتحدة إلى وقف فوري وغير مشروط لإطلاق النار في قطاع غزة، مؤكّداً أن الوضع الإنساني يتدهور بشكل كارثي وأن المدنيين يدفعون الثمن الأكبر.',
                ...
                [
                    'title'    => 'منظمات دولية تحذّر من مجاعة وشيكة في شمال غزة',
                    'excerpt'  => 'أصدرت منظمات إنسانية دولية تقريراً يحذّر من وصول الوضع الغذائي في شمال قطاع غزة إلى مرحلة المجاعة خلال الأسابيع المقبلة.',
                ...
                [
                    'title'    => 'القدس: حملة اعتقالات واسعة في الضفة الغربية',
                    'excerpt'  => 'شنّت قوات الاحتلال حملة اعتقالات واسعة في مدن الضفة الغربية فجر اليوم، طالت عشرات المواطنين بينهم أطفال ونساء.',
                    'image'    => 'https://images.unsplash.com/photo-1529107386315-e1a2ed48a620?w=800&h=500&fit=crop',
                    'category' => 'الضفة الغربية',
                    'date'     => 'قبل 5 ساعات',
                    'author'   => 'ليلى خالد',
                    'url'      => '#',
                ],
                [
                    'title'    => 'اقتصاد فلسطين: تراجع حاد في الناتج المحلي الإجمالي',
                    'excerpt'  => 'كشف تقرير اقتصادي جديد عن تراجع حاد في الناتج المحلي الإجمالي الفلسطيني خلال الربع الأخير نتيجة الأوضاع الراهنة.',
                ...
                [
                    'title'    => 'جامعة بيرزيت تطلق منحاً دراسية لطلاب غزة',
                    'excerpt'  => 'أعلنت جامعة بيرزيت عن إطلاق برنامج منح دراسية شاملة يستهدف طلاب قطاع غزة المتضرّرين من الحرب.',
                ...
                [
                    'title'    => 'رياضة: المنتخب الفلسطيني يستعد لتصفيات كأس آسيا',
                    'excerpt'  => 'بدأ المنتخب الفلسطيني لكرة القدم معسكراً تدريبياً استعداداً للمشاركة في تصفيات كأس آسيا المقبلة.',
                ...
                [
                    'title'    => 'الثقافة الفلسطينية: معرض دولي في باريس يستعرض التراث',
                    'excerpt'  => 'افتُتح في العاصمة الفرنسية باريس معرض دولي يستعرض جوانب من التراث الفلسطيني يشارك فيه عدد من الفنانين.',
    ...
    $ppostRest     = $ppostLatestItems->slice(1)->take(6);
@endphp
