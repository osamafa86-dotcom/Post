@php use App\Enums\LinkStatusEnum; @endphp
    ...
    <!-- ==================== Create / Edit Footer Link (devlo-modal) ==================== -->
<div class="modal fade" id="footer_linkForm" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
     aria-labelledby="footerLinkFormLabel" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog modal-lg"><!-- wider for comfortable rhythm -->
        <div class="modal-content devlo-modal"><!-- unified shell -->
            <!-- Header -->
            <div class="modal-header devlo-modal__header">
                <h5 class="modal-title" id="footerLinkFormLabel">
            ...
            <div class="modal-body">
                <!-- NOTE: keep same Livewire action -->
                <form wire:submit.prevent="createFooterLink" class="devlo-form">
                    <!-- Link type -->
                    <div class="field">
                        <label class="field__label"
                               for="link_status">{{ __('messages.navbar_links.link_type') }}</label>
                    ...
                    <div class="field">
                        <button class="accordion-button collapsed devlo-acc__btn" type="button"
                                data-bs-toggle="collapse" data-bs-target="#footerIconPicker" aria-expanded="false"
                                aria-controls="footerIconPicker">
                            # {{ __('messages.navbar_links.icon') }}
                        </button>
                        <div id="footerIconPicker" class="accordion-collapse collapse mt-3">
                            <div class="icon-grid">
                                @if($this->icons)
...
<!-- ==================== Delete Footer Link (devlo-modal) ==================== -->
<div class="modal fade" id="footer_linkDelete" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
     aria-labelledby="footerLinkDeleteLabel" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog">
        <div class="modal-content devlo-modal">
            <div class="modal-header devlo-modal__header devlo-modal__header--danger">
                <h5 class="modal-title" id="footerLinkDeleteLabel">{{ __('messages.navbar_links.delete_link') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="{{ __('messages.cancel') }}"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer gap-2">
                ...
                <button wire:click="navbar_linkDeleteConfirm" class="btn btn-danger">
                    {{ __('messages.confirm') }}
                </button>
            </div>
        </div>
