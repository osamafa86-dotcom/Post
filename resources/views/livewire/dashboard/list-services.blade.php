...
@section('title')
    {{config('system.site_name') . ' - '}}{{ __('messages.services.services') }}
@endsection
@section('style')
    <style>
        .th-btn {
...
<div>
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">{{ __('messages.services.services') }}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <!--begin::Card toolbar-->
                        ...
                        @can('services_create')
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <!--begin::Add product-->
                                <a wire:click="addNew" class="btn btn-primary">{{ __('messages.services.add_service') }}</a>
                                <!--end::Add product-->
                            </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                        ...
                        <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                            <th class="text-start min-w-70px th-btn"
                                wire:click="sortBy('id')">{{ __('messages.services.id') }}
                            </th>
                            <th class="text-start min-w-70px th-btn"
                            >{{ __('messages.services.image') }}</th>
                            <th class="text-start min-w-70px">{{ __('messages.services.title') }}
                            </th>
                            <th class="text-start min-w-70px">{{ __('messages.services.description') }}
                            </th>
                            <th class="text-start min-w-70px">{{ __('messages.services.url') }}
                            </th>
                            <th class="text-start min-w-70px">{{ __('messages.services.button_title') }}
                            </th>
                            <th class="text-start min-w-70px">{{ __('messages.services.is_show') }}
                            </th>
                        ...
                        @foreach($this->services as $key => $item)
                            <tr>
                                ...
                                <td class="text-start ">
                                    {{$item->is_show ?  __('messages.services.show')  :  __('messages.services.not_show') }}
                                </td>
    ...
    <!--end::Content-->
        ...
        @include('components.modals.services_modals')
                ...
                Swal.fire(
                    {
                        ...
                        text: '{{ __('messages.alert_message.service_saved') }}',
                        icon: 'success',
        ...
        document.addEventListener('DOMContentLoaded', function () {
            document.body.addEventListener('hide_delete', function () {
                Swal.fire(
                    {
                        title: '{{ __('messages.alert_message.success') }}',
                        text: '{{ __('messages.alert_message.service_deleted') }}',
                        icon: 'success',
                        confirmButtonText: '{{ __('messages.alert_message.done') }}',
                        customClass: {
                            confirmButton: 'btn btn-success'
