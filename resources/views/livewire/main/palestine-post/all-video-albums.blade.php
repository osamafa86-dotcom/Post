                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-4">
                                    <div class="podcast-img2">
                                        <!-- استخدم صورة من dummyimage أو أي صورة لديك -->
                                ...
                                <div class="col-md-8">
                                    <div class="podcast-content h-100 d-flex  justify-content-between">
                                        <div class="p-3">
                                            <h5 class="podcast-title mb-2">  {{$item->name}}</h5>
                                        ...
                                        <div class="p-3 d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="{{route('main.palestine_post.single_video' , ['category_id' => $item?->category?->relationable?->id , 'category_title' => $item?->category?->relationable?->category_title])}}" class="btn btn-play">
