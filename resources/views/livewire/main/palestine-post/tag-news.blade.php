...
@section('title')
    {{config('system.site_name')  ? config('system.site_name') : 'فلسطين بوست' }} | {{$tag_name ?? 'جميع الاخبار'}}
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 d-flex align-items-center justify-content-between">
                    <h4 class="title-breadcrumb">{{$tag_name ?? 'جميع الاخبار'}}</h4>
...
{{--                                        <h4 class="card-title-with-dot">--}}
{{--                                            <a href="{{route('main.palestine_post.category_news' , ['category_title' => $item->category?->category_title ])}}"> {{$item->category?->category_title}} </a>--}}
{{--                                        </h4>--}}
{{--                                    </div>--}}
                                    <p class="date">
