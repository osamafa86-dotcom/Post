...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasColumn('special_pages', 'publish_status_int')) {
            if (Schema::hasColumn('special_pages', 'publish_status')) {
        ...
        // 2) حوّل النصوص إلى أرقام (لو العمود النصي موجود)
        if (Schema::hasColumn('special_pages', 'publish_status')) {
            DB::statement("
                UPDATE `special_pages` SET `publish_status_int` =
                    CASE `publish_status`
    ...
    public function down(): void
    {
        ...
        if (!Schema::hasColumn('special_pages', 'publish_status_text')) {
            Schema::table('special_pages', function (Blueprint $table) {
        ...
        if (Schema::hasColumn('special_pages', 'publish_status')) {
            DB::statement("
                UPDATE `special_pages` SET `publish_status_text` =
                    CASE `publish_status`
